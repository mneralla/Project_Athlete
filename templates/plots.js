...
async function buildPlot(){
  let data = await d3.json("athletes.json");
...
async function changeName(){
  ...
  var dateValue = dateElement.property("value");
	...
	if (dateValue === "ALL"){
		let dataName = await d3.json("athletes.json");
...
async function changeSport(){
  ...
  var dateValue = dateElement.property("value");
	...
	// Get data for all years
	if (dateValue === "ALL"){
		let dataSport = await d3.json("athletes.json");
...
async function changeNationality(){
  ...
  var dateValue = dateElement.property("value");
	...
	// Get data	for all years
	if (dateValue === "ALL"){
		let dataNationality = await d3.json("athletes.json");
